...
public class DBBuilder {
        ...
        public static List<List<String>> getBuilder() {
            ...
            String TABLE_PERSON = "CREATE TABLE t_person (t_id INTEGER PRIMARY KEY AUTOINCREMENT, t_username text, " +
                    "t_address text, dt_birthday date, dt_created date, t_email text, t_gender bool, t_password text, " +
                    "t_sport int)";
